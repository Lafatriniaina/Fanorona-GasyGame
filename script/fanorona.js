...
tableDisplay();
document.getElementById('player').style.background = '#999';
				...
				for(let j=colonne-1; j<=b; j++){
					if(tabInit[i][j] == 0){
						...
						function change(){
							...
							winnerPlayer();
							if (player1 == false) {
								document.getElementById('player').style.background = '#333';
							}
...
function winnerPlayer() {
	if (cptclick[0][0] == 1 && cptclick[0][1] == 1 && cptclick[0][2] == 1){
		if (tabInit[1][1]==1 && tabInit[1][2]==1 && tabInit[1][3]==1){ winner(1); }
		if (tabInit[2][1]==1 && tabInit[2][2]==1 && tabInit[2][3]==1){ winner(1); }
		if (tabInit[3][1]==1 && tabInit[3][2]==1 && tabInit[3][3]==1){ winner(1); }
		if (tabInit[1][1]==1 && tabInit[2][1]==1 && tabInit[3][1]==1){ winner(1); }
		if (tabInit[1][2]==1 && tabInit[2][2]==1 && tabInit[3][2]==1){ winner(1); }
		if (tabInit[1][3]==1 && tabInit[2][3]==1 && tabInit[3][3]==1){ winner(1); }
		if (tabInit[1][1]==1 && tabInit[2][2]==1 && tabInit[3][3]==1){ winner(1); }
		if (tabInit[1][3]==1 && tabInit[2][2]==1 && tabInit[3][1]==1){ winner(1); }
	}
	if (cptclick[1][0] == 1 && cptclick[1][1] == 1 && cptclick[1][2] == 1){
		if (tabInit[1][1]==2 && tabInit[1][2]==2 && tabInit[1][3]==2){ winner(2); }
		if (tabInit[2][1]==2 && tabInit[2][2]==2 && tabInit[2][3]==2){ winner(2); }
		if (tabInit[3][1]==2 && tabInit[3][2]==2 && tabInit[3][3]==2){ winner(2); }
		if (tabInit[1][1]==2 && tabInit[2][1]==2 && tabInit[3][1]==2){ winner(2); }
		if (tabInit[1][2]==2 && tabInit[2][2]==2 && tabInit[3][2]==2){ winner(2); }
		if (tabInit[1][3]==2 && tabInit[2][3]==2 && tabInit[3][3]==2){ winner(2); }
		if (tabInit[1][1]==2 && tabInit[2][2]==2 && tabInit[3][3]==2){ winner(2); }
		if (tabInit[1][3]==2 && tabInit[2][2]==2 && tabInit[3][1]==2){ winner(2); }
	}

	function winner(player){
		box_winner = document.getElementById('result');
		var txtWin = "<div style='background:black;'>";
		txtWin +="<p style='margin-top:80px;font-size:50px; color:#fff; text-align:center'>Mpilalao " + player + " no nandresy</p>"; 
		txtWin +="</div>";
		box_winner.innerHTML = txtWin;
	}
}